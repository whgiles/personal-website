---
title: Remote OpenClaw Setup with Private Access over WireGuard
slug: remote-openclaw-wireguard-private-access
summary: How to run OpenClaw on a cloud VM while keeping dashboard access private through a WireGuard VPN and Nginx.
...
Install OpenClaw using the official docs: [https://docs.openclaw.ai/start/getting-started](https://docs.openclaw.ai/start/getting-started)
